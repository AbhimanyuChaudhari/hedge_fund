...
from execution.risk.risk import RiskManager, RiskConfig
from execution.orders.portfolio import Portfolio
from execution.orders.order_manager import OrderManager
from processing.features.feature_engine import FeatureEngine, TickBar
from strategies.implementations.avellaneda_stoikov.v1.strategy import BaseStrategy
from scripts.auth import get_kite_client
...
class LiveEngine:
    ...
    def _run_paper_historical(self):
        """
        Offline paper trading on S3 processed features.
        ...
        logger.info("Loading historical data from S3...")
        ...
        bucket   = os.getenv('S3_BUCKET_NAME', 'hedge-fund-data-ac')
        response = s3.list_objects_v2(
            Bucket=bucket,
            Prefix=f"processed/features/{self.symbol}/"
        )
