...
import argparse
from strategies.implementations.avellaneda_stoikov.v1.engine import BacktestEngine, BacktestConfig
...
def main():
    ...
    if args.realistic:
        ...
        from strategies.backtesting.order_book import SimulatedOrderBook
