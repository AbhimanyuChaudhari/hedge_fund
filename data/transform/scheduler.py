...
from data.store.s3_client import list_files
from data.transform.duckdb_pipeline import run_pipeline
from data.transform.options_pipeline import run_options_pipeline
...
def get_processed_bar_counts() -> dict:
    ...
    """
    from data.store.s3_client import get_gcs_client
    ...
    try:
        ...
        for f in files:
            ...
            try:
                ...
                gcs_path = f"s3://hedge-fund-494103-marketdata-mumbai/{f}"
