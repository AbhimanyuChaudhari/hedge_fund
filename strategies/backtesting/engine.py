...
Usage (same as original):
    from strategies.backtesting.engine import FastBacktestEngine, BacktestConfig
    from strategies.implementations.avellaneda_stoikov.model import AvellanedaStoikovStrategy
...
Or use run_fast_backtest() directly for even faster batch runs:
    from strategies.backtesting.engine import run_fast_backtest_batch
...
from strategies.backtesting.fill_simulator import run_fast_backtest, FastBacktestResult
from strategies.backtesting.data_loader import load_day
from strategies.backtesting.metrics import BacktestMetrics
...
# # ── END DEBUG BLOCK ────────────────────────────────────────────────────────
    ...
    try:
        from strategies.implementations.avellaneda_stoikov.v1.engine import BacktestEngine
        from strategies.implementations.avellaneda_stoikov.v1.engine import BacktestConfig as OrigConfig
        from strategies.implementations.avellaneda_stoikov.v1.strategy import StrategyConfig
        from strategies.implementations.avellaneda_stoikov.model import AvellanedaStoikovStrategy
        from strategies.implementations.avellaneda_stoikov.v1.fill_simulator import RealisticOrderBook
