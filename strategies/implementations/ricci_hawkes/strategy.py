...
from strategies.implementations.avellaneda_stoikov.v1.strategy import BaseStrategy, StrategyConfig
from strategies.backtesting.order_book import SimulatedOrderBook, Side, Fill

from strategies.implementations.ricci_hawkes.market_classifier import (
    MarketClassifier, ClassifierResult
)
from strategies.implementations.ricci_hawkes.hawkes_process import (
    HawkesProcess, HawkesState
)
from strategies.implementations.ricci_hawkes.short_term_alpha import (
    ShortTermAlpha, AlphaState
)
from strategies.implementations.ricci_hawkes.fill_rate import (
...
class RicciHawkesAlphaStrategy(BaseStrategy):
    ...
    def enable_ml(self, predictor=None) -> bool:
        ...
        Usage:
            ...
            from models.training.lgbm_predictor import LGBMPredictor
